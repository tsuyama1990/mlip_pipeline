...
class EonWrapper:
    ...
    def _prepare_directory(self, work_dir: Path, structure: Atoms, potential_path: Path):
        # 1. Write config.ini
    ...
    def _write_config(self, work_dir: Path):
    ...
    def _write_pos_con(self, filepath: Path, atoms: Atoms):
