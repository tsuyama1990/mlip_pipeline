...
def create_components(
    config: Config,
) -> tuple[Explorer, Selector, Oracle, Trainer, Validator | None, ProductionDeployer]:
    ...
    # Production
    production_deployer = ProductionDeployer(output_dir=Path())

    return explorer, selector, oracle, trainer, validator, production_deployer
...
def main() -> None:
    ...
    try:
        ...
        explorer, selector, oracle, trainer, validator, production_deployer = (
        ...
        orch = Orchestrator(
            ...
            trainer=trainer,
            validator=validator,
            production_deployer=production_deployer,
        )
