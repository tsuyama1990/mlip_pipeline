...
class DFTResult(BaseModel):
    ...
    def check_stress_shape(
        ...
        # Check if stress is empty list (legacy behavior compatibility)
        if len(stress) == 0:
            return None
        ...
        # If it's Voigt (6,) - passed as list of lists? unlikely here given Type Hint.
        # Strict 3x3 enforcement
        raise ValueError("Stress tensor must be 3x3 matrix.")
