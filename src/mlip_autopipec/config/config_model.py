...
class ExplorerConfig(BaseModel):
    ...
    type: Literal["random", "md", "mock"] = Field(default="mock", description="Type of exploration engine")

class OracleConfig(BaseModel):
    model_config = ConfigDict(extra="forbid")
    type: Literal["espresso", "mock"] = Field(default="mock", description="Type of oracle")

class TrainerConfig(BaseModel):
    model_config = ConfigDict(extra="forbid")
    type: Literal["pacemaker", "mock"] = Field(default="mock", description="Type of trainer")
