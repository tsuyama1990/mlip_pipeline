...
def test_builder_molecule_failure() -> None:
    target = TargetSystem(name="molecule_Invalid", elements=["H"], composition={"H": 1.0}, crystal_structure=None)
...
def test_builder_bulk_fallback() -> None:
    target = TargetSystem(name="Al", elements=["Al"], composition={"Al": 1.0}, crystal_structure="fcc")
