...
def test_md_runner_interface(basic_config: InferenceConfig, mock_atoms: Atoms, tmp_path: Path) -> None:
    runner: MDRunner = LammpsRunner(basic_config, work_dir=tmp_path)
